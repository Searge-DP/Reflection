/*
 * This file ("ItemReflectionSword.java") is part of the Reflection Mod for Minecraft.
...
public class ItemReflectionSword extends ItemSword{

    public ItemReflectionSword(String name, boolean addTab, Item.ToolMaterial material){
        super(material);
