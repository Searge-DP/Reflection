/*
 * This file ("ItemReflectionAxe.java") is part of the Reflection Mod for Minecraft.
...
public class ItemReflectionAxe extends ItemAxe{

    public ItemReflectionAxe(String name, boolean addTab, ToolMaterial material){
        super(material);
