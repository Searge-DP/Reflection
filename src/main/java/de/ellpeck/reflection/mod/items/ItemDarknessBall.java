...
public class ItemDarknessBall extends ItemBase{
    ...
    private static Map<IBlockState, IBlockState> replacements = new HashMap<IBlockState, IBlockState>();
    ...
    public static void init(){
        ...
        replacements.put(Blocks.diamond_block.getDefaultState(), Blocks.obsidian.getDefaultState());
        replacements.put(InitBlocks.blockLightanium.getDefaultState(), InitBlocks.blockDarkness.getDefaultState());
        replacements.put(InitBlocks.blockOreLightanium.getDefaultState(), InitBlocks.blockOreDarkness.getDefaultState());
    }
